...
Run 'docker build -t tensorflow/pubg_ml_cpu_server:1.0.0 .' in this directory to build the dockerfile. It has flask dependencies installed so you can serve up the model.

Run the image with 'docker run --network=host tensorflow/pubg_ml_cpu_server:1.0.0'
